...
PROMPT=$'
%{\e[0;31m%}┌─[%{\e[1;34m%}%B%{\${TNAME}%}%{\e[1;33m%}@%{\e[1;36m%}termux%b%{\e[0;31m%}]☠️SengkangXploiter☠️[%{\e[0;32m%}%(4~|/%2~|%~)%{\e[0;31m%}]%b
...
clear;
echo -e "\033[31m$(figlet -f XOneTzy "Sengkangxploiter")\e[0m"
echo -e "\e[1;32m
+----------------------------------*/
