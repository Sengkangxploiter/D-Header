...
rubygem_d &> /dev/null
termux-wake-lock;
if [ -e $PREFIX/share/figlet/X.OneTzy.flf ]; then
	echo -e "\e[1;34m[*] \033[32mX.ONE TZY.flf figlet font is present\033[0m";
	sleep 4
else
wget https://raw.githubusercontent.com/x.onetzy/X.OneTzy/master/X.OneTzy.flf &> /dev/null;
sleep 3
cp X.OneTzy.flf $PREFIX/share/figlet/X.OneTzy.flf;
...
#echo -e '\033[1;43;30m### FOLLOW MY IG LUCIFER_XRIFAN ### \033[0m';
#echo -e '\e[0;35m+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+\e[00m';
echo "";
echo -e "
\033[0;31m┌─[\033[1;34m$TNAME\033[1;33m@\033[1;36mtermux\033[0;31m]─[\033[0;32mSengkangXploiter${PWD/#"$HOME"}\033[0;31m]
...
PROMPT=$'
%{\e[0;31m%}┌─[%{\e[1;34m%}%B%{\${TNAME}%}%{\e[1;33m%}@%{\e[1;36m%}termux%b%{\e[0;31m%}]--️[SengkangXploiter%{\e[0;32m%}%(4~|/%2~|%~)%{\e[0;31m%}]%b
...
clear;
echo -e "\033[31m$(figlet .flf XOneTzy "T- Header")\e[0m"
echo -e "\e[1;32m
+----------------------------------*/
X.OneTzy : (\e[33m14.4.2024\e[32m)
